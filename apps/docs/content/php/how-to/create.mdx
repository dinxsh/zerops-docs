...
Zerops provides highly scalable and customizable PHP services with integrated web servers: **PHP+Nginx** and **PHP+Apache**. These services support both development and production environments with features like automatic scaling, high availability, and environment variable management.

For more details on PHP features in Zerops, see the [PHP documentation](/php/overview).

This guide explains how to create a new PHP service using either the Zerops GUI or command-line interface (zCLI).
...
- (Optional) [zCLI installed](/references/cli) if you plan to use the command-line.
- Basic familiarity with PHP and web servers. See [PHP concepts](/php/concepts) for an overview.
...
:::info
You can [change](/php/how-to/upgrade) the major version at any time later. See [version management](/php/how-to/versions) for details.
:::
