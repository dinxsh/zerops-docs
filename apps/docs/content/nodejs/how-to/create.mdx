...
:::info
You can [change](/nodejs/how-to/upgrade) the major version at any time later.
:::
...
Read more about [different types of env variables](/nodejs/how-to/env-variables#types-of-env-variables-in-zerops) in Zerops.
...
:::tip
Learn more about how to [fine tune](/nodejs/how-to/scaling#fine-tune-the-auto-scaling) the auto scaling to fit your application needs.
:::
...
[Learn more](/nodejs/how-to/scaling) about Node.js auto scaling.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Set type:{' '}
        `
          nodejs<span>@</span>&lt;version&gt;
        `{' '}
        or{' '}
        `
          nodejs<span>@</span>latest
        `
        <br />
        <br />
        <b>Limitations:</b>
        <br />
        Following Node.js major versions are currently supported: <i>20</i>,
        <i>18</i>,<i>16</i>
      </td>
    </tr>
    <tr>
      ...
      <td>
        ...
        <a href="/nodejs/how-to/create#set-auto-scaling-configuration">
    ...
    <tr>
      ...
      <td>
        ...
        for{' '}
        <a href="/nodejs/how-to/create#horizontal-auto-scaling">
    ...
    <tr>
      ...
      <td>
        ...
        <a href="/nodejs/how-to/env-variables#env-variable-restrictions">
          restrictions
        </a>
        .
      </td>
